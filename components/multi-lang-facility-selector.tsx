...
import type { MultiLangArray } from "@/lib/types"

interface MultiLangFacilitySelectorProps {
  value: MultiLangArray
  onChange: (value: MultiLangArray) => void
  disabled?: boolean
}

export function MultiLangFacilitySelector({ value, onChange, disabled = false }: MultiLangFacilitySelectorProps) {
